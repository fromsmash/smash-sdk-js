...
export const errors = {
    ...
    UploadTransferFilePartError: {
        BadRequest: UploadTransferFilePartBadRequestError,
        InternalServer: UploadTransferFilePartInternalServerError,
        NotFound: UploadTransferFilePartNotFoundError,
        NoSuchUpload: UploadTransferFilePartNoSuchUploadError,
        AccessControlListNotSupported: UploadTransferFilePartAccessControlListNotSupportedError,
        AccessDenied: UploadTransferFilePartAccessDeniedError,
        AccessPointAlreadyOwnedByYou: UploadTransferFilePartAccessPointAlreadyOwnedByYouError,
        AccountProblem: UploadTransferFilePartAccountProblemError,
        AllAccessDisabled: UploadTransferFilePartAllAccessDisabledError,
        AmbiguousGrantByEmailAddress: UploadTransferFilePartAmbiguousGrantByEmailAddressError,
        AuthorizationHeaderMalformed: UploadTransferFilePartAuthorizationHeaderMalformedError,
        BadDigest: UploadTransferFilePartBadDigestError,
        EntityTooSmall: UploadTransferFilePartEntityTooSmallError,
        EntityTooLarge: UploadTransferFilePartEntityTooLargeError,
        ExpiredToken: UploadTransferFilePartExpiredTokenError,
        IllegalLocationConstraintException: UploadTransferFilePartIllegalLocationConstraintExceptionError,
        IllegalVersioningConfigurationException: UploadTransferFilePartIllegalVersioningConfigurationExceptionError,
        IncompleteBody: UploadTransferFilePartIncompleteBodyError,
        InlineDataTooLarge: UploadTransferFilePartInlineDataTooLargeError,
        Internal: UploadTransferFilePartInternalError,
        InvalidAccessKeyId: UploadTransferFilePartInvalidAccessKeyIdError,
        InvalidArgument: UploadTransferFilePartInvalidArgumentError,
        InvalidBucketName: UploadTransferFilePartInvalidBucketNameError,
        InvalidBucketState: UploadTransferFilePartInvalidBucketStateError,
        InvalidDigest: UploadTransferFilePartInvalidDigestError,
        InvalidLocationConstraint: UploadTransferFilePartInvalidLocationConstraintError,
        InvalidObjectState: UploadTransferFilePartInvalidObjectStateError,
        InvalidPart: UploadTransferFilePartInvalidPartError,
        InvalidPartOrder: UploadTransferFilePartInvalidPartOrderError,
        InvalidPayer: UploadTransferFilePartInvalidPayerError,
        InvalidPolicyDocument: UploadTransferFilePartInvalidPolicyDocumentError,
        InvalidRange: UploadTransferFilePartInvalidRangeError,
        InvalidRequest: UploadTransferFilePartInvalidRequestError,
        InvalidSecurity: UploadTransferFilePartInvalidSecurityError,
        InvalidToken: UploadTransferFilePartInvalidTokenError,
        InvalidURI: UploadTransferFilePartInvalidURIError,
        KeyTooLong: UploadTransferFilePartKeyTooLongError,
        MaxMessageLengthExceeded: UploadTransferFilePartMaxMessageLengthExceededError,
        MetadataTooLarge: UploadTransferFilePartMetadataTooLargeError,
        MissingContentLength: UploadTransferFilePartMissingContentLengthError,
        MissingRequestBody: UploadTransferFilePartMissingRequestBodyError,
        MissingSecurityHeader: UploadTransferFilePartMissingSecurityHeaderError,
        NoSuchBucket: UploadTransferFilePartNoSuchBucketError,
        NoSuchBucketPolicy: UploadTransferFilePartNoSuchBucketPolicyError,
        NoSuchCORSConfiguration: UploadTransferFilePartNoSuchCORSConfigurationError,
        NoSuchKey: UploadTransferFilePartNoSuchKeyError,
        NotImplemented: UploadTransferFilePartNotImplementedError,
        RequestHeaderSectionTooLarge: UploadTransferFilePartRequestHeaderSectionTooLargeError,
        RequestTimeout: UploadTransferFilePartRequestTimeoutError,
        RequestTimeTooSkewed: UploadTransferFilePartRequestTimeTooSkewedError,
        ServerSideEncryptionConfigurationNotFound: UploadTransferFilePartServerSideEncryptionConfigurationNotFoundError,
        ServiceUnavailable: UploadTransferFilePartServiceUnavailableError,
        SignatureDoesNotMatch: UploadTransferFilePartSignatureDoesNotMatchError,
        SlowDown: UploadTransferFilePartSlowDownError,
        TokenRefreshRequired: UploadTransferFilePartTokenRefreshRequiredError,
        UnexpectedContent: UploadTransferFilePartUnexpectedContentError,
        UserKeyMustBeSpecified: UploadTransferFilePartUserKeyMustBeSpecifiedError,
        UnknownError,
        NetworkError,
    },
};
