...
<h1 align="center">@smash-sdk/image</h1>
</p>
<br />
<p align="center">
  <a href="https://npmjs.com/package/@smash-sdk/image"><img
      src="https://img.shields.io/npm/v/@smash-sdk/image.svg" /></a>
  <br />
  <img
...
You can install @smash-sdk/image using npm:


```bash
npm install @smash-sdk/image
```
...
```js
// Using ES6 module
import { Image } from '@smash-sdk/image/10-2019';
```

```js
// Or using CommonJS module
const { Image } = require('@smash-sdk/image/10-2019');
```

### Usage

```js
const image = new Image({ region: "eu-west-3", token: "Put your Smash API Key here" });
```

Parameters:

- `region` (required): A string indicating the Smash region to use for the SDK Image. **It should be the same region as your API key**. To find the
...
You can find node usage and integration examples of @smash-sdk/image in the dedicated [examples
folder](https://github.com/fromsmash/example-js/tree/main/node/ts).

## Contributing

Contibutions are welcome! If you'd like to help improving @smash-sdk/image, please fork the repository, make your changes, and submit a pull request.

## License

@smash-sdk/image is released under the MIT License